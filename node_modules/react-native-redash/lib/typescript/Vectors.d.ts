...
export declare const vec: {
    ...
    dot: (v1: Vector<Animated.Adaptable<number>>, v2: Vector<Animated.Adaptable<number>>) => {
        x: Animated.Node<number>;
        y: Animated.Node<number>;
    };
    ...
    length: (v: Vector<Animated.Adaptable<number>>) => Animated.Node<number>;
    normalize: (v: Vector<Animated.Adaptable<number>>) => {
        x: Animated.Node<number>;
        y: Animated.Node<number>;
    };
    cross: (v1: Vector<Animated.Adaptable<number>>, v2: Vector<Animated.Adaptable<number>>) => {
        x: Animated.Node<number>;
        y: Animated.Node<number>;
    };
};
